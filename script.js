...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        'nav-why': { ro: 'De Ce AMGF?', en: 'Why AMGF?' }, // Nou adăugat
        'nav-links': { ro: 'Link-uri Utile', en: 'Useful Links' }, // Nou adăugat
        'nav-vision': { ro: 'Viziune', en: 'Vision' }, // Nou adăugat
        ...
        'links-desc': { ro: 'Alătură-te comunității noastre și explorează platformele unde poți achiziționa și tranzacționa AMGF.', en: 'Join our community and explore the platforms where you can acquire and trade AMGF.' },
        'link-telegram': { ro: 'Canalul Oficial Telegram', en: 'Official Telegram Channel' },
        'link-exchange1': { ro: 'Tranzacționează pe [NUME BURSĂ 1]', en: 'Trade on [EXCHANGE NAME 1]' },
        'link-exchange2': { ro: 'Tranzacționează pe [NUME BURSĂ 2]', en: 'Trade on [EXCHANGE NAME 2]' },
        ...
        'disclaimer-p2': { ro: 'Vă rugăm să efectuați propria cercetare (DYOR - Do Your Own Research) și să consultați un profesionist financiar calificat înainte de a lua orice decizie de investiție. Proiectul AMGF nu garantează profituri și nu este responsabil pentru nicio pierdere suferită ca urmare a investițiilor bazate pe informațiile de pe acest site.', en: 'Please conduct your own research (DYOR - Do Your Own Research) and consult a qualified financial professional before making any investment decisions. The AMGF project does not guarantee profits and is not responsible for any losses incurred as a result of investments based on the information on this site.' },
